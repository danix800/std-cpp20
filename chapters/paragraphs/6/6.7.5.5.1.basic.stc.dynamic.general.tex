...
中隐式声明。\par
\qquad\tm{[[nodiscard]] void* operator new(std::size\_t);}\par
\qquad\tm{[[nodiscard]] void* operator new(std::size\_t, std::align\_val\_t);}\\
\par
\qquad\tm{void operator delete(void*) noexcept;} \par
\qquad\tm{void operator delete(void*, std::size\_t) noexcept;} \par
\qquad\tm{void operator delete(void*, std::align\_val\_t) noexcept;} \par
\qquad\tm{void operator delete(void*, std::size\_t, std::align\_val\_t) noexcept;}\\
\par
\qquad\tm{[[nodiscard]] void* operator new[](std::size\_t);}\par
\qquad\tm{[[nodiscard]] void* operator new[](std::size\_t, std::align\_val\_t);}\\
\par
