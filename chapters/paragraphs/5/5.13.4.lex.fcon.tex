...
\synsym{hexadecimal-floating-point-literal}
  \synprd{\nt{hexadecimal-prefix hexadecimal-fractional-constant
    binary-exponent-part floating-point-suffix\tsub{opt}}}
  \synprd{\nt{hexadecimal-prefix hexadecimal-digit-sequence binary-exponent-part
    floating-point-suffix\tsub{opt}}}
...
\begin{example}
  ...
  \nt{floating-point-literal} \tm{1.602'176'565e-19}和\tm{1.602176565e-19}具有相
  同值。
\end{example}
