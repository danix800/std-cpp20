...
\renewcommand{\theparagraph}{\hspace{-2.5em}\arabic{paragraph}}
...
\newcounter{transnotecounter}
\newenvironment{transnote}
{\stepcounter{transnotecounter}$\llbracket$译注\thetransnotecounter：}
{--- 译注终$\rrbracket$}

\newcommand{\recprac}[1]{\textit{推荐实践}：#1}

\newenvironment{codeenv}{\par}{}
\newcommand{\code}[1]{\mbox{\qquad\tm{#1}}\par}

\newcounter{notecounter}
\renewenvironment{note}
{\stepcounter{notecounter}$\llbracket$\textit{注\thenotecounter}：}
{--- \textit{注终}$\rrbracket$}

\newcounter{excounter}
\renewenvironment{example}
{\stepcounter{excounter}$\llbracket$\textit{例\theexcounter}：}
{--- \textit{例终}$\rrbracket$}
